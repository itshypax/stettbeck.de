...
<body class="d-flex flex-column justify-content-center align-items-center bg-sh-gray" style="height:100vh;width:100vw">
    <h1 class="m-5">
        ...
        Entweder gibt es keinen Test mit dieser ID, du hast keine ID angegeben oder er wurde bereits ausgefüllt. 🤔
    </h1>
    <div class="my-3"></div>
    <a href="/" class="btn btn-sh-red btn-lg">Zurück zum Stadtportal</a>
</body>
