...
$sql = "SELECT * FROM ws_ids WHERE hash = '$testid' AND used = 0";
...
if ($result != 1) {
    ...
    $sql2 = "UPDATE ws_ids SET used = 1 WHERE hash = '$testid'";
...
<head>
    ...
    <title>Formular Waffenschein &rsaquo; Hansestadt Stettbeck</title>
    <!-- Stylesheets -->
...
<body class="d-flex flex-column justify-content-center align-items-center bg-sh-gray" style="height:100vh;width:100vw">
    ...
    <div class="container h-50 d-flex flex-column justify-content-center p-5 border border-4 border-sh-red shadow-sm" id="formContainer">
        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeaHCK61bwSB0he4Um-OtahIBPpDdl2vbxjLZimCq-GVJiMLg/viewform?embedded=true" width="100%" height="750px" frameborder="0" marginheight="0" marginwidth="0">Wird geladen…</iframe>
