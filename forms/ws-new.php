...
if ($allw != "laPoSH") {
    ...
    $sql = "INSERT INTO ws_ids (hash) VALUES ('$hash')";
...
<body class="d-flex flex-column justify-content-center align-items-center bg-sh-gray" style="height:100vh;width:100vw">
    <h1>
        <a href="https://stettbeck.de/forms/waffenschein?test=<?= $hash ?>" id="copy-link">https://stettbeck.de/forms/waffenschein?test=<?= $hash ?></a>
    </h1>
